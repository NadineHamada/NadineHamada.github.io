...
# 
**Boundary ceiling**= the channel's true capacity- a property of the physics.the best any conceivable protocol could ever achieve on that specific boundary.
**Protocol ceiling**= what your actual, specific code/decoder achieves right now. Can sit anywhere at or below the boundary ceiling.
